  ...
  return (
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled || menuOpen || currentPage !== 'home' ? 'bg-[#faf9f6]/95 backdrop-blur-md border-b border-stone-200/50 shadow-sm' : 'bg-transparent'} ${isScrolled ? 'py-1' : 'py-2'}`}
      >
